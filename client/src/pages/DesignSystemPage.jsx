    ...
    <div className="py-12 md:py-16 bg-background">
      ...
      <Container>
        ...
        <div className="max-w-3xl space-y-4 mb-10 pb-8 border-b border-border">
          ...
          <h1 className="font-h1 text-[#075A46]">
        ...
        {activeTab === 'components' && (
          <div className="space-y-12 animate-in fade-in duration-200">
            ...
            <div className="bg-surface border border-border rounded-healix-xl p-8 space-y-6">
              <div>
                <h2 className="font-h3 text-[#075A46] mb-1">Button Component (All Variants & Sizes)</h2>
            ...
            <div className="bg-surface border border-border rounded-healix-xl p-8 space-y-6">
              <div>
                <h2 className="font-h3 text-[#075A46] mb-1">Badge Component (Status & Category Variants)</h2>
                <p className="font-small text-text-secondary">
        ...
        {activeTab === 'cards' && (
          <div className="space-y-8 animate-in fade-in duration-200">
            <div>
              <h2 className="font-h3 text-[#075A46] mb-1">Composable Card Primitives</h2>
              <p className="font-small text-text-secondary">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <Card surface="secondary">
                ...
                <CardContent>
                  <div className="text-2xl font-bold font-heading text-[#075A46] mb-2">$189<span className="text-xs font-normal text-text-muted">/month</span></div>
        ...
        {activeTab === 'forms' && (
          <div className="space-y-8 animate-in fade-in duration-200">
            <div className="max-w-2xl bg-surface border border-border rounded-healix-xl p-8 space-y-6">
              <div>
                <h2 className="font-h3 text-[#075A46] mb-1">Accessible Form Controls</h2>
                <p className="font-small text-text-secondary">
        ...
        {activeTab === 'disclosures' && (
          <div className="space-y-12 animate-in fade-in duration-200">
            ...
            <div className="bg-surface border border-border rounded-healix-xl p-8 space-y-4 max-w-2xl">
              <h2 className="font-h3 text-[#075A46]">Accessible Modal Dialog</h2>
              <p className="font-small text-text-secondary">
            ...
            <div className="bg-surface border border-border rounded-healix-xl p-8 space-y-6 max-w-3xl">
              <div>
                <h2 className="font-h3 text-[#075A46] mb-1">Accessible Accordion Primitive</h2>
                <p className="font-small text-text-secondary">
          ...
          <div className="space-y-12 animate-in fade-in duration-200">
            ...
            <div className="bg-surface border border-border rounded-healix-xl p-8 space-y-6">
              <div className="flex flex-wrap items-center justify-between gap-4">
                <div>
                  <h2 className="font-h3 text-[#075A46] mb-1">Toast Notifications</h2>
                  <p className="font-small text-text-secondary">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-surface border border-border rounded-healix-xl p-8 space-y-6">
                <h3 className="font-h4 text-[#075A46]">Breadcrumb & Loaders</h3>
              ...
              <div className="bg-surface border border-border rounded-healix-xl p-8 space-y-4">
                <h3 className="font-h4 text-[#075A46]">Empty State Primitive</h3>
                <EmptyState
                  icon={Compass}
        ...
        {activeTab === 'tokens' && (
          <div className="space-y-6 bg-surface border border-border rounded-healix-xl p-8">
            <h2 className="font-h3 text-[#075A46]">Core Component System API Summary</h2>
            <p className="font-body text-text-secondary">
