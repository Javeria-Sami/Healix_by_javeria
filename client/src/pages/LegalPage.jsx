        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="font-heading text-3xl font-extrabold text-[#075C49]">{currentTitle}</h1>
            </div>
          </div>
          ...
          <div className="bg-surface border border-border rounded-healix-xl p-8 sm:p-10 space-y-6 text-sm text-text-secondary leading-relaxed">
            ...
            <h2 className="font-heading text-lg font-bold text-[#075C49] pt-2">1. Health Information Privacy & Safeguards</h2>
            <p>
            ...
            <h2 className="font-heading text-lg font-bold text-[#075C49] pt-2">2. Digital Telehealth & Service Scope</h2>
            <p>
            ...
            <h2 className="font-heading text-lg font-bold text-[#075C49] pt-2">3. Data Security & Storage</h2>
            <p>
