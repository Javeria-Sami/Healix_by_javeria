    ...
    <section className="py-16 md:py-24 bg-surface border-y border-border" aria-labelledby="about-trust-heading">
      <Container>
        <div className="max-w-3xl mx-auto text-center space-y-4 mb-12">
          ...
          <h2 id="about-trust-heading" className="font-heading text-3xl sm:text-4xl font-extrabold text-[#075C49]">
          ...
          {credentials.map((cred, idx) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-heading font-bold text-sm text-[#075C49]">
                  {cred.title}
                </h3>
