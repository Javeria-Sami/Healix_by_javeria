    ...
    <section className="py-14 md:py-20 bg-background" aria-labelledby="mission-vision-heading">
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left items-stretch">
          ...
          <div className="p-7 sm:p-9 bg-[#F3F8F5] border border-[#075C49]/15 rounded-2xl space-y-4 shadow-soft-xs flex flex-col justify-between transition-colors">
            <div className="space-y-3.5">
              <div className="w-11 h-11 rounded-xl bg-[#075C49]/10 text-[#075C49] flex items-center justify-center">
                <Shield className="w-5 h-5" aria-hidden="true" />
              </div>
              <div className="text-xs font-bold uppercase tracking-wider text-[#075C49]">
                Our Purpose
              </div>
              <h2 id="mission-heading" className="font-heading font-extrabold text-2xl sm:text-3xl text-[#075C49] tracking-tight">
                Our Mission
              </h2>
          ...
          <div className="p-7 sm:p-9 bg-white border border-border/80 rounded-2xl space-y-4 shadow-soft-xs flex flex-col justify-between transition-colors">
            <div className="space-y-3.5">
              ...
              <h2 id="vision-heading" className="font-heading font-extrabold text-2xl sm:text-3xl text-[#075C49] tracking-tight">
                Our Vision
              </h2>
              <p className="font-body text-sm sm:text-base text-text-secondary leading-relaxed">
