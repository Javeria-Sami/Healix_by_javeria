      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="relative bg-background border border-border rounded-healix-2xl p-6 sm:p-8 shadow-soft-lg">
              <div className="flex items-center justify-between pb-4 border-b border-border">
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="font-heading font-bold text-sm text-[#075A46]">
              ...
              <div className="py-6 space-y-5">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-heading font-bold text-xs text-[#075A46]">
          ...
          <div className="lg:col-span-6 space-y-6 text-left order-1 lg:order-2">
            ...
            <h2 id="featured-solution-heading" className="font-heading text-3xl sm:text-4xl font-extrabold text-[#075A46] leading-tight">
              The Longitudinal <br />
            ...
            <div className="space-y-4 pt-2">
              {diagnosticPillars.map((pillar, idx) => (
                <div key={idx} className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-heading font-bold text-sm text-[#075A46]">{pillar.title}</h4>
