  ...
  return (
    <section className="max-w-3xl mx-auto space-y-5 pt-8 border-t border-neutral-100">
      <div className="flex items-center gap-2">
        <Stethoscope className="w-5 h-5 text-[#075C49]" />
        ...
        {connectedServices.map((service) => (
          ...
          >
            <div className="space-y-1.5 text-left">
              ...
              <h3 className="font-heading text-sm font-bold text-[#075C49] leading-snug">
                {service.title}
              </h3>
            ...
            <div className="pt-3 border-t border-neutral-100 mt-4 text-left">
              <Link
                ...
                className="inline-flex items-center gap-1 text-xs font-bold text-[#075C49] hover:text-[#054839] transition-colors"
              >
