...
export function ResourcesCTA() {
  return (
    <section className="pt-8 pb-16 md:pt-12 md:pb-24">
      <div className="bg-[#075B43] border border-[#0D7657]/40 rounded-3xl p-8 sm:p-12 lg:p-16 text-white text-center space-y-6 relative overflow-hidden shadow-xl">
        <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-white/10 text-white text-xs font-semibold border border-white/20">
          <Sparkles className="w-3.5 h-3.5 text-[#98CF2D]" />
        ...
        <p className="text-[#DCEBE4] text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
