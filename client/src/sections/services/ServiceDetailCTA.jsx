...
export function ServiceDetailCTA({ serviceTitle }) {
  return (
      ...
      <PageContainer>
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <h2 className="font-heading text-3xl sm:text-4xl font-extrabold tracking-tight">
            Ready to Begin with <br className="hidden sm:inline" />
            <span className="font-serif italic font-normal text-accent-light">
              {serviceTitle || 'Our Clinical Program'}?
            </span>
          </h2>

          <p className="text-white/80 text-base sm:text-lg max-w-xl mx-auto leading-relaxed">
            Reserve your assessment slot or speak with an intake specialist to discuss personalized diagnostic planning.
          </p>

          <div className="pt-2 flex flex-wrap items-center justify-center gap-4">
            <Button
              to={`${ROUTES.CONTACT}?service=${encodeURIComponent(serviceTitle || '')}&type=Clinical%20Services%20Consultation`}
              variant="secondary"
              size="lg"
