        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="aspect-[4/5] w-full rounded-healix-xl overflow-hidden bg-secondary border border-border shadow-soft-sm relative">
              ...
              />
              <div className="absolute top-3 right-3 bg-surface/95 backdrop-blur-sm text-xs font-bold text-[#075A46] px-3 py-1 rounded-full border border-border">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <h1 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#075A46] tracking-tight leading-[1.15]">
              {professional.name}
            </h1>
